...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "16.0.14");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "cehp"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'bl2bkT35GvXM7d4z', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/cehp.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{05E6FA99-8810-4D67-B99E-99E893A4E81D}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "10.1.2.95", "port" => "3309", "user" => "root", "pass" => "password", "db" => "cehp"]
	],
	...
	"SESSION_TIMEOUT" => 15, // Session timeout time (minutes)

	// Session keep alive interval
	"SESSION_KEEP_ALIVE_INTERVAL" => 29, // Session keep alive interval (seconds)
	...
	"USER_LEVEL_DBID" => "DB",
	"USER_LEVEL_TABLE" => "`master_user_roles`",
	"USER_LEVEL_ID_FIELD" => "`RoleId`",
	"USER_LEVEL_NAME_FIELD" => "`RoleName`",

	// User Level privileges table/field names
	"USER_LEVEL_PRIV_DBID" => "DB",
	"USER_LEVEL_PRIV_TABLE" => "`master_user_permission`",
	...
	"USER_TABLE_NAME" => "master_user",
	"LOGIN_USERNAME_FIELD_NAME" => "UserId",
	"LOGIN_PASSWORD_FIELD_NAME" => "UserPassword",
	"USER_ID_FIELD_NAME" => "UserId",
	"PARENT_USER_ID_FIELD_NAME" => "",
	"USER_LEVEL_FIELD_NAME" => "RoleId",
	"USER_PROFILE_FIELD_NAME" => "UserProfile",
	"REGISTER_ACTIVATE_FIELD_NAME" => "",
	"USER_EMAIL_FIELD_NAME" => "UserEmail",

	// User table filters
	"USER_TABLE_DBID" => "DB",
	"USER_TABLE" => "`master_user`",
	"USER_NAME_FILTER" => "(`UserId` = '%u')",
	"USER_ID_FILTER" => "(`UserId` = '%u')",
	"USER_EMAIL_FILTER" => "(`UserEmail` = '%e')",
	...
	"SMTP_SERVER_USERNAME" => "admin@samartha.info", // SMTP server user name
	"SMTP_SERVER_PASSWORD" => "124\\\$Samartha", // SMTP server password
	"SENDER_EMAIL" => "admin@samartha.info", // Sender email address
	"RECIPIENT_EMAIL" => "jagdish.damania@samarthainfo.com", // Recipient email address
	"MAX_EMAIL_RECIPIENT" => 9,
...
$LANGUAGES = [["en","","english.xml"],["kn","","Kannada.xml"]];
