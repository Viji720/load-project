 ...
 * Page class
 */
class lkp_isfirstmsg_delete extends lkp_isfirstmsg
{
	...
	// Page object name
	public $PageObjName = "lkp_isfirstmsg_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lkp_isfirstmsglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lkp_isfirstmsglist.php"); // Return to list
			}
		}
	}
