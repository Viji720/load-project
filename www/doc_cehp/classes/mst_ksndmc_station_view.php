 ...
 * Page class
 */
class mst_ksndmc_station_view extends mst_ksndmc_station
{
	...
	// Page object name
	public $PageObjName = "mst_ksndmc_station_view";
	...
	public function run()
	{
		...
		$this->kgis_district_id->setVisibility();
		$this->kgis_taluka_id->setVisibility();
		$this->kgis_hobli_id->setVisibility();
		$this->kgis_village_id->setVisibility();
		$this->kwris_basin_id->setVisibility();
		$this->kwris_subbasin_id->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Raingauge_id") !== NULL) {
				...
				$returnUrl = "mst_ksndmc_stationlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "mst_ksndmc_stationlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "mst_ksndmc_stationlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
