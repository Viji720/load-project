...
/**
 * Table class for vw_rpt_sms_analyser
 */
class vw_rpt_sms_analyser extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vw_rpt_sms_analyser';
		$this->TableName = 'vw_rpt_sms_analyser';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_rpt_sms_analyser`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// SMSDateTime
		$this->SMSDateTime = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_SMSDateTime', 'SMSDateTime', '`SMSDateTime`', CastDateFieldForLike("`SMSDateTime`", 7, "DB"), 133, 10, 7, FALSE, '`SMSDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Num_of_Records
		$this->Num_of_Records = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Num_of_Records', 'Num_of_Records', '`Num_of_Records`', '`Num_of_Records`', 131, 23, -1, FALSE, '`Num_of_Records`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Percent_completed
		$this->Percent_completed = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Percent_completed', 'Percent_completed', '`Percent_completed`', '`Percent_completed`', 131, 28, -1, FALSE, '`Percent_completed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Num_of_SMS_Received
		$this->Num_of_SMS_Received = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Num_of_SMS_Received', 'Num_of_SMS_Received', '`Num_of_SMS_Received`', '`Num_of_SMS_Received`', 131, 23, -1, FALSE, '`Num_of_SMS_Received`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Num_of_Created_1
		$this->Num_of_Created_1 = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Num_of_Created_1', 'Num_of_Created_1', '`Num_of_Created_1`', '`Num_of_Created_1`', 131, 23, -1, FALSE, '`Num_of_Created_1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Num_of_Entered_by_Subdivision = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Num_of_Entered_by_Subdivision', 'Num_of_Entered_by_Subdivision', '`Num_of_Entered_by_Subdivision`', '`Num_of_Entered_by_Subdivision`', 131, 23, -1, FALSE, '`Num_of_Entered_by_Subdivision`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Num_of_Verified
		$this->Num_of_Verified = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Num_of_Verified', 'Num_of_Verified', '`Num_of_Verified`', '`Num_of_Verified`', 131, 23, -1, FALSE, '`Num_of_Verified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Num_of_Status_0
		$this->Num_of_Status_0 = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Num_of_Status_0', 'Num_of_Status_0', '`Num_of_Status_0`', '`Num_of_Status_0`', 131, 23, -1, FALSE, '`Num_of_Status_0`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Num_of_Not_Given
		$this->Num_of_Not_Given = new DbField('vw_rpt_sms_analyser', 'vw_rpt_sms_analyser', 'x_Num_of_Not_Given', 'Num_of_Not_Given', '`Num_of_Not_Given`', '`Num_of_Not_Given`', 131, 23, -1, FALSE, '`Num_of_Not_Given`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vw_rpt_sms_analyser`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "vw_rpt_sms_analyserlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vw_rpt_sms_analyserview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vw_rpt_sms_analyseredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vw_rpt_sms_analyseradd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vw_rpt_sms_analyserview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vw_rpt_sms_analyserview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vw_rpt_sms_analyseradd.php?" . $this->getUrlParm($parm);
		else
			$url = "vw_rpt_sms_analyseradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_rpt_sms_analyseredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_rpt_sms_analyseradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vw_rpt_sms_analyserdelete.php", $this->getUrlParm());
	}
