 ...
 * Page class
 */
class lkp_isfirstmsg_add extends lkp_isfirstmsg
{
	...
	// Page object name
	public $PageObjName = "lkp_isfirstmsg_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("isFirstMsg") !== NULL) {
				...
				$this->setKey("isFirstMsg", $this->isFirstMsg->CurrentValue); // Set up key
			} else {
				$this->setKey("isFirstMsg", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "lkp_isfirstmsgview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->isFirstMsgName->CurrentValue = NULL;
		$this->isFirstMsgName->OldValue = $this->isFirstMsgName->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['isFirstMsgName'] = $this->isFirstMsgName->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// isFirstMsg
		$this->isFirstMsg->setDbValueDef($rsnew, $this->isFirstMsg->CurrentValue, 0, FALSE);

		// isFirstMsgName
		$this->isFirstMsgName->setDbValueDef($rsnew, $this->isFirstMsgName->CurrentValue, NULL, FALSE);
		...
		if ($insertRow && $this->ValidateKey && strval($rsnew['isFirstMsg']) == "") {
