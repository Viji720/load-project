 ...
 * Page class
 */
class lkp_status_add extends lkp_status
{
	...
	// Page object name
	public $PageObjName = "lkp_status_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("Status") !== NULL) {
				...
				$this->setKey("Status", $this->Status->CurrentValue); // Set up key
			} else {
				$this->setKey("Status", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "lkp_statusview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->StatusName->CurrentValue = NULL;
		$this->StatusName->OldValue = $this->StatusName->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['StatusName'] = $this->StatusName->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// StatusName
		$this->StatusName->setDbValueDef($rsnew, $this->StatusName->CurrentValue, NULL, FALSE);
		...
		if ($insertRow && $this->ValidateKey && strval($rsnew['Status']) == "") {
