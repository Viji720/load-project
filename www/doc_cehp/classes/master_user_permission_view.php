 ...
 * Page class
 */
class master_user_permission_view extends master_user_permission
{
	...
	// Page object name
	public $PageObjName = "master_user_permission_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("master_user_permissionlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "master_user_permissionlist.php"; // Return to list
			}
			if (Get("_tablename") !== NULL) {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "master_user_permissionlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "master_user_permissionlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("master_user_permissionlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
