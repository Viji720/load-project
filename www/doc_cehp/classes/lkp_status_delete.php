 ...
 * Page class
 */
class lkp_status_delete extends lkp_status
{
	...
	// Page object name
	public $PageObjName = "lkp_status_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lkp_statuslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lkp_statuslist.php"); // Return to list
			}
		}
	}
