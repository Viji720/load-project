 ...
 * Page class
 */
class master_station_list extends master_station
{
	...
	// Page object name
	public $PageObjName = "master_station_list";

	// Grid form hidden field names
	public $FormName = "fmaster_stationlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "master_stationadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "master_stationdelete.php";
		$this->MultiUpdateUrl = "master_stationupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fmaster_stationlistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fmaster_stationlistsrch");
		...
		$filterList = Concat($filterList, $this->Altitude_MSL_in_mtrs->AdvancedSearch->toJson(), ","); // Field Altitude_MSL_in_mtrs
		...
		$filterList = Concat($filterList, $this->last_active_date->AdvancedSearch->toJson(), ","); // Field last_active_date
		...
		$filterList = Concat($filterList, $this->CatchUpId->AdvancedSearch->toJson(), ","); // Field CatchUpId
		$filterList = Concat($filterList, $this->PIC->AdvancedSearch->toJson(), ","); // Field PIC
		$filterList = Concat($filterList, $this->RiverId->AdvancedSearch->toJson(), ","); // Field RiverId
		$filterList = Concat($filterList, $this->Address->AdvancedSearch->toJson(), ","); // Field Address
		$filterList = Concat($filterList, $this->max_rainfall_date->AdvancedSearch->toJson(), ","); // Field max_rainfall_date
		$filterList = Concat($filterList, $this->max_rainfall->AdvancedSearch->toJson(), ","); // Field max_rainfall
		$filterList = Concat($filterList, $this->last_reading_date->AdvancedSearch->toJson(), ","); // Field last_reading_date
		$filterList = Concat($filterList, $this->first_reading_date->AdvancedSearch->toJson(), ","); // Field first_reading_date
		$filterList = Concat($filterList, $this->no_of_manual_entry->AdvancedSearch->toJson(), ","); // Field no_of_manual_entry
		$filterList = Concat($filterList, $this->no_of_sms->AdvancedSearch->toJson(), ","); // Field no_of_sms
		$filterList = Concat($filterList, $this->NewStationCode->AdvancedSearch->toJson(), ","); // Field NewStationCode
		...
		$filterList = Concat($filterList, $this->StationName_hi->AdvancedSearch->toJson(), ","); // Field StationName_hi
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fmaster_stationlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field Altitude_MSL_in_mtrs
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchValue = @$filter["x_Altitude_MSL_in_mtrs"];
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchOperator = @$filter["z_Altitude_MSL_in_mtrs"];
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchCondition = @$filter["v_Altitude_MSL_in_mtrs"];
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchValue2 = @$filter["y_Altitude_MSL_in_mtrs"];
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchOperator2 = @$filter["w_Altitude_MSL_in_mtrs"];
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->save();
		...
		$this->last_active_date->AdvancedSearch->SearchValue = @$filter["x_last_active_date"];
		$this->last_active_date->AdvancedSearch->SearchOperator = @$filter["z_last_active_date"];
		$this->last_active_date->AdvancedSearch->SearchCondition = @$filter["v_last_active_date"];
		$this->last_active_date->AdvancedSearch->SearchValue2 = @$filter["y_last_active_date"];
		$this->last_active_date->AdvancedSearch->SearchOperator2 = @$filter["w_last_active_date"];
		$this->last_active_date->AdvancedSearch->save();
		...
		// Field CatchUpId
		$this->CatchUpId->AdvancedSearch->SearchValue = @$filter["x_CatchUpId"];
		$this->CatchUpId->AdvancedSearch->SearchOperator = @$filter["z_CatchUpId"];
		$this->CatchUpId->AdvancedSearch->SearchCondition = @$filter["v_CatchUpId"];
		$this->CatchUpId->AdvancedSearch->SearchValue2 = @$filter["y_CatchUpId"];
		$this->CatchUpId->AdvancedSearch->SearchOperator2 = @$filter["w_CatchUpId"];
		$this->CatchUpId->AdvancedSearch->save();
		...
		// Field RiverId
		$this->RiverId->AdvancedSearch->SearchValue = @$filter["x_RiverId"];
		$this->RiverId->AdvancedSearch->SearchOperator = @$filter["z_RiverId"];
		$this->RiverId->AdvancedSearch->SearchCondition = @$filter["v_RiverId"];
		$this->RiverId->AdvancedSearch->SearchValue2 = @$filter["y_RiverId"];
		$this->RiverId->AdvancedSearch->SearchOperator2 = @$filter["w_RiverId"];
		$this->RiverId->AdvancedSearch->save();
		...
		// Field max_rainfall_date
		$this->max_rainfall_date->AdvancedSearch->SearchValue = @$filter["x_max_rainfall_date"];
		$this->max_rainfall_date->AdvancedSearch->SearchOperator = @$filter["z_max_rainfall_date"];
		$this->max_rainfall_date->AdvancedSearch->SearchCondition = @$filter["v_max_rainfall_date"];
		$this->max_rainfall_date->AdvancedSearch->SearchValue2 = @$filter["y_max_rainfall_date"];
		$this->max_rainfall_date->AdvancedSearch->SearchOperator2 = @$filter["w_max_rainfall_date"];
		$this->max_rainfall_date->AdvancedSearch->save();

		// Field max_rainfall
		$this->max_rainfall->AdvancedSearch->SearchValue = @$filter["x_max_rainfall"];
		$this->max_rainfall->AdvancedSearch->SearchOperator = @$filter["z_max_rainfall"];
		$this->max_rainfall->AdvancedSearch->SearchCondition = @$filter["v_max_rainfall"];
		$this->max_rainfall->AdvancedSearch->SearchValue2 = @$filter["y_max_rainfall"];
		$this->max_rainfall->AdvancedSearch->SearchOperator2 = @$filter["w_max_rainfall"];
		$this->max_rainfall->AdvancedSearch->save();

		// Field last_reading_date
		$this->last_reading_date->AdvancedSearch->SearchValue = @$filter["x_last_reading_date"];
		$this->last_reading_date->AdvancedSearch->SearchOperator = @$filter["z_last_reading_date"];
		$this->last_reading_date->AdvancedSearch->SearchCondition = @$filter["v_last_reading_date"];
		$this->last_reading_date->AdvancedSearch->SearchValue2 = @$filter["y_last_reading_date"];
		$this->last_reading_date->AdvancedSearch->SearchOperator2 = @$filter["w_last_reading_date"];
		$this->last_reading_date->AdvancedSearch->save();

		// Field first_reading_date
		$this->first_reading_date->AdvancedSearch->SearchValue = @$filter["x_first_reading_date"];
		$this->first_reading_date->AdvancedSearch->SearchOperator = @$filter["z_first_reading_date"];
		$this->first_reading_date->AdvancedSearch->SearchCondition = @$filter["v_first_reading_date"];
		$this->first_reading_date->AdvancedSearch->SearchValue2 = @$filter["y_first_reading_date"];
		$this->first_reading_date->AdvancedSearch->SearchOperator2 = @$filter["w_first_reading_date"];
		$this->first_reading_date->AdvancedSearch->save();

		// Field no_of_manual_entry
		$this->no_of_manual_entry->AdvancedSearch->SearchValue = @$filter["x_no_of_manual_entry"];
		$this->no_of_manual_entry->AdvancedSearch->SearchOperator = @$filter["z_no_of_manual_entry"];
		$this->no_of_manual_entry->AdvancedSearch->SearchCondition = @$filter["v_no_of_manual_entry"];
		$this->no_of_manual_entry->AdvancedSearch->SearchValue2 = @$filter["y_no_of_manual_entry"];
		$this->no_of_manual_entry->AdvancedSearch->SearchOperator2 = @$filter["w_no_of_manual_entry"];
		$this->no_of_manual_entry->AdvancedSearch->save();

		// Field no_of_sms
		$this->no_of_sms->AdvancedSearch->SearchValue = @$filter["x_no_of_sms"];
		$this->no_of_sms->AdvancedSearch->SearchOperator = @$filter["z_no_of_sms"];
		$this->no_of_sms->AdvancedSearch->SearchCondition = @$filter["v_no_of_sms"];
		$this->no_of_sms->AdvancedSearch->SearchValue2 = @$filter["y_no_of_sms"];
		$this->no_of_sms->AdvancedSearch->SearchOperator2 = @$filter["w_no_of_sms"];
		$this->no_of_sms->AdvancedSearch->save();

		// Field NewStationCode
		$this->NewStationCode->AdvancedSearch->SearchValue = @$filter["x_NewStationCode"];
		$this->NewStationCode->AdvancedSearch->SearchOperator = @$filter["z_NewStationCode"];
		$this->NewStationCode->AdvancedSearch->SearchCondition = @$filter["v_NewStationCode"];
		$this->NewStationCode->AdvancedSearch->SearchValue2 = @$filter["y_NewStationCode"];
		$this->NewStationCode->AdvancedSearch->SearchOperator2 = @$filter["w_NewStationCode"];
		$this->NewStationCode->AdvancedSearch->save();
		...
		// Field StationName_hi
		$this->StationName_hi->AdvancedSearch->SearchValue = @$filter["x_StationName_hi"];
		$this->StationName_hi->AdvancedSearch->SearchOperator = @$filter["z_StationName_hi"];
		$this->StationName_hi->AdvancedSearch->SearchCondition = @$filter["v_StationName_hi"];
		$this->StationName_hi->AdvancedSearch->SearchValue2 = @$filter["y_StationName_hi"];
		$this->StationName_hi->AdvancedSearch->SearchOperator2 = @$filter["w_StationName_hi"];
		$this->StationName_hi->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->Altitude_MSL_in_mtrs, $default, FALSE); // Altitude_MSL_in_mtrs
		...
		$this->buildSearchSql($where, $this->last_active_date, $default, FALSE); // last_active_date
		...
		$this->buildSearchSql($where, $this->CatchUpId, $default, FALSE); // CatchUpId
		$this->buildSearchSql($where, $this->PIC, $default, FALSE); // PIC
		$this->buildSearchSql($where, $this->RiverId, $default, FALSE); // RiverId
		$this->buildSearchSql($where, $this->Address, $default, FALSE); // Address
		$this->buildSearchSql($where, $this->max_rainfall_date, $default, FALSE); // max_rainfall_date
		$this->buildSearchSql($where, $this->max_rainfall, $default, FALSE); // max_rainfall
		$this->buildSearchSql($where, $this->last_reading_date, $default, FALSE); // last_reading_date
		$this->buildSearchSql($where, $this->first_reading_date, $default, FALSE); // first_reading_date
		$this->buildSearchSql($where, $this->no_of_manual_entry, $default, FALSE); // no_of_manual_entry
		$this->buildSearchSql($where, $this->no_of_sms, $default, FALSE); // no_of_sms
		$this->buildSearchSql($where, $this->NewStationCode, $default, FALSE); // NewStationCode
		...
		$this->buildSearchSql($where, $this->StationName_hi, $default, FALSE); // StationName_hi
		...
		if (!$default && $this->Command == "search") {
			...
			$this->Altitude_MSL_in_mtrs->AdvancedSearch->save(); // Altitude_MSL_in_mtrs
			$this->station_type->AdvancedSearch->save(); // station_type
			$this->IsActive->AdvancedSearch->save(); // IsActive
			$this->last_active_date->AdvancedSearch->save(); // last_active_date
			...
			$this->CatchUpId->AdvancedSearch->save(); // CatchUpId
			$this->PIC->AdvancedSearch->save(); // PIC
			$this->RiverId->AdvancedSearch->save(); // RiverId
			$this->Address->AdvancedSearch->save(); // Address
			$this->max_rainfall_date->AdvancedSearch->save(); // max_rainfall_date
			$this->max_rainfall->AdvancedSearch->save(); // max_rainfall
			$this->last_reading_date->AdvancedSearch->save(); // last_reading_date
			$this->first_reading_date->AdvancedSearch->save(); // first_reading_date
			$this->no_of_manual_entry->AdvancedSearch->save(); // no_of_manual_entry
			$this->no_of_sms->AdvancedSearch->save(); // no_of_sms
			$this->NewStationCode->AdvancedSearch->save(); // NewStationCode
			$this->DivisionId->AdvancedSearch->save(); // DivisionId
			$this->StationSetup->AdvancedSearch->save(); // StationSetup
			$this->StationName_hi->AdvancedSearch->save(); // StationName_hi
		}
		return $where;
	}
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->Altitude_MSL_in_mtrs, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->IsActive, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->SubBasinId, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->PIC, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Address, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->NewStationCode, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->StationSetup, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->StationName_hi, $arKeywords, $type);
		return $where;
	}
	...
	protected function checkSearchParms()
	{
		...
		if ($this->Latitude->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Altitude_MSL_in_mtrs->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->station_type->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->IsActive->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->last_active_date->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->SubBasinId->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->CatchUpId->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->PIC->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->RiverId->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Address->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->max_rainfall_date->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->max_rainfall->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->last_reading_date->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->first_reading_date->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->no_of_manual_entry->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->no_of_sms->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->NewStationCode->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DivisionId->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->StationSetup->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->StationName_hi->AdvancedSearch->issetSession())
			return TRUE;
		return FALSE;
	}
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->unsetSession();
		$this->station_type->AdvancedSearch->unsetSession();
		$this->IsActive->AdvancedSearch->unsetSession();
		$this->last_active_date->AdvancedSearch->unsetSession();
		...
		$this->CatchUpId->AdvancedSearch->unsetSession();
		$this->PIC->AdvancedSearch->unsetSession();
		$this->RiverId->AdvancedSearch->unsetSession();
		$this->Address->AdvancedSearch->unsetSession();
		$this->max_rainfall_date->AdvancedSearch->unsetSession();
		$this->max_rainfall->AdvancedSearch->unsetSession();
		$this->last_reading_date->AdvancedSearch->unsetSession();
		$this->first_reading_date->AdvancedSearch->unsetSession();
		$this->no_of_manual_entry->AdvancedSearch->unsetSession();
		$this->no_of_sms->AdvancedSearch->unsetSession();
		$this->NewStationCode->AdvancedSearch->unsetSession();
		$this->DivisionId->AdvancedSearch->unsetSession();
		$this->StationSetup->AdvancedSearch->unsetSession();
		$this->StationName_hi->AdvancedSearch->unsetSession();
	}
	...
	protected function restoreSearchParms()
	{
		...
		$this->Altitude_MSL_in_mtrs->AdvancedSearch->load();
		$this->station_type->AdvancedSearch->load();
		$this->IsActive->AdvancedSearch->load();
		$this->last_active_date->AdvancedSearch->load();
		...
		$this->CatchUpId->AdvancedSearch->load();
		$this->PIC->AdvancedSearch->load();
		$this->RiverId->AdvancedSearch->load();
		$this->Address->AdvancedSearch->load();
		$this->max_rainfall_date->AdvancedSearch->load();
		$this->max_rainfall->AdvancedSearch->load();
		$this->last_reading_date->AdvancedSearch->load();
		$this->first_reading_date->AdvancedSearch->load();
		$this->no_of_manual_entry->AdvancedSearch->load();
		$this->no_of_sms->AdvancedSearch->load();
		$this->NewStationCode->AdvancedSearch->load();
		$this->DivisionId->AdvancedSearch->load();
		$this->StationSetup->AdvancedSearch->load();
		$this->StationName_hi->AdvancedSearch->load();
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->StationName_kn, $ctrl); // StationName_kn
			...
			$this->updateSort($this->Altitude_MSL_in_mtrs, $ctrl); // Altitude_MSL_in_mtrs
			$this->updateSort($this->station_type, $ctrl); // station_type
			$this->updateSort($this->IsActive, $ctrl); // IsActive
			$this->updateSort($this->last_active_date, $ctrl); // last_active_date
			...
			$this->updateSort($this->CatchUpId, $ctrl); // CatchUpId
			$this->updateSort($this->PIC, $ctrl); // PIC
			$this->updateSort($this->RiverId, $ctrl); // RiverId
			$this->updateSort($this->max_rainfall_date, $ctrl); // max_rainfall_date
			$this->updateSort($this->max_rainfall, $ctrl); // max_rainfall
			$this->updateSort($this->last_reading_date, $ctrl); // last_reading_date
			$this->updateSort($this->first_reading_date, $ctrl); // first_reading_date
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->StationName_kn->setSort("");
				$this->MobileNumber->setSort("");
				$this->Longitude->setSort("");
				$this->Latitude->setSort("");
				$this->Altitude_MSL_in_mtrs->setSort("");
				$this->station_type->setSort("");
				$this->IsActive->setSort("");
				$this->last_active_date->setSort("");
				$this->DistrictId->setSort("");
				$this->TalukID->setSort("");
				$this->BasinId->setSort("");
				$this->SubBasinId->setSort("");
				$this->CatchUpId->setSort("");
				$this->PIC->setSort("");
				$this->RiverId->setSort("");
				$this->max_rainfall_date->setSort("");
				$this->max_rainfall->setSort("");
				$this->last_reading_date->setSort("");
				$this->first_reading_date->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fmaster_stationlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmaster_stationlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fmaster_stationlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function loadSearchValues()
	{
		...
		if (!$this->isAddOrEdit() && $this->Altitude_MSL_in_mtrs->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchValue != "" || $this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// last_active_date
		if (!$this->isAddOrEdit() && $this->last_active_date->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->last_active_date->AdvancedSearch->SearchValue != "" || $this->last_active_date->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// CatchUpId
		if (!$this->isAddOrEdit() && $this->CatchUpId->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->CatchUpId->AdvancedSearch->SearchValue != "" || $this->CatchUpId->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// PIC
		if (!$this->isAddOrEdit() && $this->PIC->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->PIC->AdvancedSearch->SearchValue != "" || $this->PIC->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// RiverId
		if (!$this->isAddOrEdit() && $this->RiverId->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->RiverId->AdvancedSearch->SearchValue != "" || $this->RiverId->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// max_rainfall_date
		if (!$this->isAddOrEdit() && $this->max_rainfall_date->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->max_rainfall_date->AdvancedSearch->SearchValue != "" || $this->max_rainfall_date->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// max_rainfall
		if (!$this->isAddOrEdit() && $this->max_rainfall->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->max_rainfall->AdvancedSearch->SearchValue != "" || $this->max_rainfall->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// last_reading_date
		if (!$this->isAddOrEdit() && $this->last_reading_date->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->last_reading_date->AdvancedSearch->SearchValue != "" || $this->last_reading_date->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// first_reading_date
		if (!$this->isAddOrEdit() && $this->first_reading_date->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->first_reading_date->AdvancedSearch->SearchValue != "" || $this->first_reading_date->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// no_of_manual_entry
		if (!$this->isAddOrEdit() && $this->no_of_manual_entry->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->no_of_manual_entry->AdvancedSearch->SearchValue != "" || $this->no_of_manual_entry->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// no_of_sms
		if (!$this->isAddOrEdit() && $this->no_of_sms->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->no_of_sms->AdvancedSearch->SearchValue != "" || $this->no_of_sms->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// NewStationCode
		if (!$this->isAddOrEdit() && $this->NewStationCode->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->NewStationCode->AdvancedSearch->SearchValue != "" || $this->NewStationCode->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// StationName_hi
		if (!$this->isAddOrEdit() && $this->StationName_hi->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->StationName_hi->AdvancedSearch->SearchValue != "" || $this->StationName_hi->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$curVal = trim(strval($this->SubDivisionId->AdvancedSearch->SearchValue));
			if ($curVal != "")
				$this->SubDivisionId->AdvancedSearch->ViewValue = $this->SubDivisionId->lookupCacheOption($curVal);
			else
				$this->SubDivisionId->AdvancedSearch->ViewValue = $this->SubDivisionId->Lookup !== NULL && is_array($this->SubDivisionId->Lookup->Options) ? $curVal : NULL;
			if ($this->SubDivisionId->AdvancedSearch->ViewValue !== NULL) { // Load from cache
				$this->SubDivisionId->EditValue = array_values($this->SubDivisionId->Lookup->Options);
			} else { // Lookup from database
				if ($curVal == "") {
					$filterWrk = "0=1";
				} else {
					$filterWrk = "`SubDivisionId`" . SearchString("=", $this->SubDivisionId->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
				}
			...
			if (!$this->StationName_kn->Raw)
				$this->StationName_kn->AdvancedSearch->SearchValue = HtmlDecode($this->StationName_kn->AdvancedSearch->SearchValue);
			$this->StationName_kn->EditValue = HtmlEncode($this->StationName_kn->AdvancedSearch->SearchValue);
			...
			$this->Altitude_MSL_in_mtrs->EditValue = HtmlEncode($this->Altitude_MSL_in_mtrs->AdvancedSearch->SearchValue);
			...
			$this->last_active_date->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->last_active_date->AdvancedSearch->SearchValue, 7), 7));
			...
			$this->max_rainfall_date->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->max_rainfall_date->AdvancedSearch->SearchValue, 7), 7));

			// max_rainfall
			$this->max_rainfall->EditAttrs["class"] = "form-control";
			$this->max_rainfall->EditCustomAttributes = "";
			$this->max_rainfall->EditValue = HtmlEncode($this->max_rainfall->AdvancedSearch->SearchValue);

			// last_reading_date
			$this->last_reading_date->EditAttrs["class"] = "form-control";
			$this->last_reading_date->EditCustomAttributes = "";
			$this->last_reading_date->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->last_reading_date->AdvancedSearch->SearchValue, 7), 7));

			// first_reading_date
			$this->first_reading_date->EditAttrs["class"] = "form-control";
			$this->first_reading_date->EditCustomAttributes = "";
			$this->first_reading_date->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->first_reading_date->AdvancedSearch->SearchValue, 7), 7));
		}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fmaster_stationlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fmaster_stationlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fmaster_stationlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_master_station" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_master_station\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fmaster_stationlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fmaster_stationlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
