 ...
 * Page class
 */
class master_user_view extends master_user
{
	...
	// Page object name
	public $PageObjName = "master_user_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("_UserId") !== NULL) {
				...
				$returnUrl = "master_userlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "master_userlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "master_userlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
