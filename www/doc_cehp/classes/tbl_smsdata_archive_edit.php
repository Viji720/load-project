 ...
 * Page class
 */
class tbl_smsdata_archive_edit extends tbl_smsdata_archive
{
	...
	// Page object name
	public $PageObjName = "tbl_smsdata_archive_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Slno
			$this->Slno->setDbValueDef($rsnew, $this->Slno->CurrentValue, 0, $this->Slno->ReadOnly);
			...
			// SendDateTime
			$this->SendDateTime->setDbValueDef($rsnew, UnFormatDateTime($this->SendDateTime->CurrentValue, 0), NULL, $this->SendDateTime->ReadOnly);
			...
			// min_air_temp
			$this->min_air_temp->setDbValueDef($rsnew, $this->min_air_temp->CurrentValue, NULL, $this->min_air_temp->ReadOnly);

			// max_air_temp
			$this->max_air_temp->setDbValueDef($rsnew, $this->max_air_temp->CurrentValue, NULL, $this->max_air_temp->ReadOnly);

			// atmospheric_pressure
			$this->atmospheric_pressure->setDbValueDef($rsnew, $this->atmospheric_pressure->CurrentValue, NULL, $this->atmospheric_pressure->ReadOnly);

			// wind_speed
			$this->wind_speed->setDbValueDef($rsnew, $this->wind_speed->CurrentValue, NULL, $this->wind_speed->ReadOnly);

			// precipitation
			$this->precipitation->setDbValueDef($rsnew, $this->precipitation->CurrentValue, NULL, $this->precipitation->ReadOnly);
