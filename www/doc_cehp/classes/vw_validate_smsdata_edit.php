 ...
 * Page class
 */
class vw_validate_smsdata_edit extends vw_validate_smsdata
{
	...
	// Page object name
	public $PageObjName = "vw_validate_smsdata_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("vw_validate_smsdatalist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "vw_validate_smsdatalist.php")
