 ...
 * Page class
 */
class master_user_edit extends master_user
{
	...
	// Page object name
	public $PageObjName = "master_user_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// UserAddress
			$this->UserAddress->setDbValueDef($rsnew, $this->UserAddress->CurrentValue, NULL, $this->UserAddress->ReadOnly);

			// StationId
			$this->StationId->setDbValueDef($rsnew, $this->StationId->CurrentValue, NULL, $this->StationId->ReadOnly);

			// TalukId
			$this->TalukId->setDbValueDef($rsnew, $this->TalukId->CurrentValue, NULL, $this->TalukId->ReadOnly);

			// DistrictId
			$this->DistrictId->setDbValueDef($rsnew, $this->DistrictId->CurrentValue, NULL, $this->DistrictId->ReadOnly);

			// SubDivsionId
			$this->SubDivsionId->setDbValueDef($rsnew, $this->SubDivsionId->CurrentValue, NULL, $this->SubDivsionId->ReadOnly);

			// DivisionId
			$this->DivisionId->setDbValueDef($rsnew, $this->DivisionId->CurrentValue, NULL, $this->DivisionId->ReadOnly);
			...
			// UserPassword
			$this->UserPassword->setDbValueDef($rsnew, $this->UserPassword->CurrentValue, NULL, $this->UserPassword->ReadOnly || Config("ENCRYPTED_PASSWORD") && $rs->fields('UserPassword') == $this->UserPassword->CurrentValue);

			// UserEmail
			$this->UserEmail->setDbValueDef($rsnew, $this->UserEmail->CurrentValue, NULL, $this->UserEmail->ReadOnly);

			// UserMobileNumber
			$this->UserMobileNumber->setDbValueDef($rsnew, $this->UserMobileNumber->CurrentValue, "", $this->UserMobileNumber->ReadOnly);

			// UserProfile
			$this->_UserProfile->setDbValueDef($rsnew, $this->_UserProfile->CurrentValue, NULL, $this->_UserProfile->ReadOnly);
