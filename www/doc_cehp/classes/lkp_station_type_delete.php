 ...
 * Page class
 */
class lkp_station_type_delete extends lkp_station_type
{
	...
	// Page object name
	public $PageObjName = "lkp_station_type_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lkp_station_typelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lkp_station_typelist.php"); // Return to list
			}
		}
	}
