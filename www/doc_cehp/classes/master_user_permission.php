...
/**
 * Table class for master_user_permission
 */
class master_user_permission extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'master_user_permission';
		$this->TableName = 'master_user_permission';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`master_user_permission`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('master_user_permission', 'master_user_permission', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new DbField('master_user_permission', 'master_user_permission', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, 191, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('master_user_permission', 'master_user_permission', 'x_permission', 'permission', '`permission`', '`permission`', 3, 11, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`master_user_permission`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "master_user_permissionlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "master_user_permissionview.php")
			return $Language->phrase("View");
		elseif ($pageName == "master_user_permissionedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "master_user_permissionadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("master_user_permissionview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("master_user_permissionview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "master_user_permissionadd.php?" . $this->getUrlParm($parm);
		else
			$url = "master_user_permissionadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("master_user_permissionedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("master_user_permissionadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("master_user_permissiondelete.php", $this->getUrlParm());
	}
