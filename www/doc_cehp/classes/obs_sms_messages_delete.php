 ...
 * Page class
 */
class obs_sms_messages_delete extends obs_sms_messages
{
	...
	// Page object name
	public $PageObjName = "obs_sms_messages_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("obs_sms_messageslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("obs_sms_messageslist.php"); // Return to list
			}
		}
	}
