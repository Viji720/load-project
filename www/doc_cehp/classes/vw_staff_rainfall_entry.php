...
/**
 * Table class for vw_staff_rainfall_entry
 */
class vw_staff_rainfall_entry extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vw_staff_rainfall_entry';
		$this->TableName = 'vw_staff_rainfall_entry';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_staff_rainfall_entry`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// obs_rainfall_ID
		$this->obs_rainfall_ID = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_obs_rainfall_ID', 'obs_rainfall_ID', '`obs_rainfall_ID`', '`obs_rainfall_ID`', 3, 11, -1, FALSE, '`obs_rainfall_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// obs_date
		$this->obs_date = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_obs_date', 'obs_date', '`obs_date`', CastDateFieldForLike("`obs_date`", 7, "DB"), 135, 19, 7, FALSE, '`obs_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// stationcode
		$this->stationcode = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_stationcode', 'stationcode', '`stationcode`', '`stationcode`', 3, 11, -1, FALSE, '`stationcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// rainfall
		$this->rainfall = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_rainfall', 'rainfall', '`rainfall`', '`rainfall`', 4, 7, -1, FALSE, '`rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rainfall->Required = TRUE; // Required field
		$this->rainfall->Sortable = TRUE; // Allow sort
		$this->rainfall->DefaultErrorMessage = str_replace(["%1", "%2"], ["0", "600"], $Language->phrase("IncorrectRange"));
		$this->fields['rainfall'] = &$this->rainfall;

		// obs_remarks
		$this->obs_remarks = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_obs_remarks', 'obs_remarks', '`obs_remarks`', '`obs_remarks`', 200, 50, -1, FALSE, '`obs_remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->obs_remarks->Sortable = TRUE; // Allow sort
		$this->fields['obs_remarks'] = &$this->obs_remarks;

		// mst_status
		$this->mst_status = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_mst_status', 'mst_status', '`mst_status`', '`mst_status`', 3, 11, -1, FALSE, '`mst_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mst_validated
		$this->mst_validated = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_mst_validated', 'mst_validated', '`mst_validated`', '`mst_validated`', 3, 11, -1, FALSE, '`mst_validated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mobile_number
		$this->mobile_number = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_mobile_number', 'mobile_number', '`mobile_number`', '`mobile_number`', 200, 25, -1, FALSE, '`mobile_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_number->Sortable = TRUE; // Allow sort
		$this->fields['mobile_number'] = &$this->mobile_number;

		// SubDivisionId
		$this->SubDivisionId = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_SubDivisionId', 'SubDivisionId', '`SubDivisionId`', '`SubDivisionId`', 3, 11, -1, FALSE, '`SubDivisionId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubDivision_code
		$this->SubDivision_code = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_SubDivision_code', 'SubDivision_code', '`SubDivision_code`', '`SubDivision_code`', 3, 11, -1, FALSE, '`SubDivision_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// obs_owner
		$this->obs_owner = new DbField('vw_staff_rainfall_entry', 'vw_staff_rainfall_entry', 'x_obs_owner', 'obs_owner', '`obs_owner`', '`obs_owner`', 200, 25, -1, FALSE, '`obs_owner`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vw_staff_rainfall_entry`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "vw_staff_rainfall_entrylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vw_staff_rainfall_entryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vw_staff_rainfall_entryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vw_staff_rainfall_entryadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vw_staff_rainfall_entryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vw_staff_rainfall_entryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vw_staff_rainfall_entryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vw_staff_rainfall_entryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_staff_rainfall_entryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_staff_rainfall_entryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vw_staff_rainfall_entrydelete.php", $this->getUrlParm());
	}
	...
	function Row_Updating($rsold, &$rsnew) {
		...
		// To cancel, set return value to FALSE
	 	...
	 	$rsnew["mst_status"] = '5'; // Entry by Web
