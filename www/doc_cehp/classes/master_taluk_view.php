 ...
 * Page class
 */
class master_taluk_view extends master_taluk
{
	...
	// Page object name
	public $PageObjName = "master_taluk_view";
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("TalukId") !== NULL) {
			$this->RecKey["TalukId"] = Get("TalukId");
			$keyUrl .= "&amp;TalukId=" . urlencode($this->RecKey["TalukId"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("TalukId") !== NULL) {
				...
				$this->RecKey["TalukId"] = $this->TalukId->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->TalukId->setQueryStringValue(Key(0));
				$this->RecKey["TalukId"] = $this->TalukId->QueryStringValue;
			} elseif (Post("TalukId") !== NULL) {
				$this->TalukId->setFormValue(Post("TalukId"));
				$this->RecKey["TalukId"] = $this->TalukId->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->TalukId->setFormValue(Route(2));
				$this->RecKey["TalukId"] = $this->TalukId->FormValue;
			} else {
				$returnUrl = "master_taluklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "master_taluklist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "master_taluklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
