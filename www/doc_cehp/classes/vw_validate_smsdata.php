...
/**
 * Table class for vw_validate_smsdata
 */
class vw_validate_smsdata extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vw_validate_smsdata';
		$this->TableName = 'vw_validate_smsdata';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_validate_smsdata`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// obs_rainfall_ID
		$this->obs_rainfall_ID = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_obs_rainfall_ID', 'obs_rainfall_ID', '`obs_rainfall_ID`', '`obs_rainfall_ID`', 3, 11, -1, FALSE, '`obs_rainfall_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// stationcode
		$this->stationcode = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_stationcode', 'stationcode', '`stationcode`', '`stationcode`', 3, 11, -1, FALSE, '`stationcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// obs_date
		$this->obs_date = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_obs_date', 'obs_date', '`obs_date`', CastDateFieldForLike("`obs_date`", 7, "DB"), 135, 19, 7, FALSE, '`obs_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rainfall
		$this->rainfall = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_rainfall', 'rainfall', '`rainfall`', '`rainfall`', 4, 7, -1, FALSE, '`rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mst_validated
		$this->mst_validated = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_mst_validated', 'mst_validated', '`mst_validated`', '`mst_validated`', 3, 11, -1, FALSE, '`mst_validated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mst_status
		$this->mst_status = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_mst_status', 'mst_status', '`mst_status`', '`mst_status`', 3, 11, -1, FALSE, '`mst_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// obs_remarks
		$this->obs_remarks = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_obs_remarks', 'obs_remarks', '`obs_remarks`', '`obs_remarks`', 200, 50, -1, FALSE, '`obs_remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->obs_remarks->Sortable = TRUE; // Allow sort
		$this->fields['obs_remarks'] = &$this->obs_remarks;

		// SubDivision_code
		$this->SubDivision_code = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_SubDivision_code', 'SubDivision_code', '`SubDivision_code`', '`SubDivision_code`', 3, 11, -1, FALSE, '`SubDivision_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubDivisionId
		$this->SubDivisionId = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_SubDivisionId', 'SubDivisionId', '`SubDivisionId`', '`SubDivisionId`', 3, 11, -1, FALSE, '`SubDivisionId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mobile_number
		$this->mobile_number = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_mobile_number', 'mobile_number', '`mobile_number`', '`mobile_number`', 200, 25, -1, FALSE, '`mobile_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_number->Sortable = TRUE; // Allow sort
		$this->fields['mobile_number'] = &$this->mobile_number;

		// obs_owner
		$this->obs_owner = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_obs_owner', 'obs_owner', '`obs_owner`', '`obs_owner`', 200, 18, -1, FALSE, '`obs_owner`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->obs_owner->Sortable = TRUE; // Allow sort
		$this->fields['obs_owner'] = &$this->obs_owner;

		// isFreeze
		$this->isFreeze = new DbField('vw_validate_smsdata', 'vw_validate_smsdata', 'x_isFreeze', 'isFreeze', '`isFreeze`', '`isFreeze`', 16, 1, -1, FALSE, '`isFreeze`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->isFreeze->Nullable = FALSE; // NOT NULL field
		$this->isFreeze->Sortable = TRUE; // Allow sort
		$this->isFreeze->DataType = DATATYPE_BOOLEAN;
		switch ($CurrentLanguage) {
			case "en":
				$this->isFreeze->Lookup = new Lookup('isFreeze', 'vw_validate_smsdata', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			case "kn":
				$this->isFreeze->Lookup = new Lookup('isFreeze', 'vw_validate_smsdata', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vw_validate_smsdata`";
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "`obs_rainfall_ID` DESC";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "vw_validate_smsdatalist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vw_validate_smsdataview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vw_validate_smsdataedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vw_validate_smsdataadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vw_validate_smsdataview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vw_validate_smsdataview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vw_validate_smsdataadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vw_validate_smsdataadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_validate_smsdataedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_validate_smsdataadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vw_validate_smsdatadelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		$this->SubDivision_code->EditValue = FormatNumber($this->SubDivision_code->EditValue, 0, -2, -2, -2);
		$this->SubDivision_code->ViewCustomAttributes = "";
	...
	public function getUserIDSubquery(&$fld, &$masterfld)
	{
		global $UserTable;
		$wrk = "";
		$sql = "SELECT " . $masterfld->Expression . " FROM `vw_validate_smsdata`";
