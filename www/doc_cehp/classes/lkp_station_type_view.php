 ...
 * Page class
 */
class lkp_station_type_view extends lkp_station_type
{
	...
	// Page object name
	public $PageObjName = "lkp_station_type_view";
	...
	public function __construct()
	{
		...
		if (Get("station_type") !== NULL) {
			$this->RecKey["station_type"] = Get("station_type");
			$keyUrl .= "&amp;station_type=" . urlencode($this->RecKey["station_type"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("station_type") !== NULL) {
				...
				$this->RecKey["station_type"] = $this->station_type->QueryStringValue;
				...
				$this->RecKey["station_type"] = $this->station_type->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->station_type->setFormValue(Route(2));
				$this->RecKey["station_type"] = $this->station_type->FormValue;
			} else {
				$returnUrl = "lkp_station_typelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "lkp_station_typelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "lkp_station_typelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
