 ...
 * Page class
 */
class tbl_sms_monthly_edit extends tbl_sms_monthly
{
	...
	// Page object name
	public $PageObjName = "tbl_sms_monthly_edit";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canEdit()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("tbl_sms_monthlylist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("tbl_sms_monthlylist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "tbl_sms_monthlylist.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("tbl_sms_monthlylist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
