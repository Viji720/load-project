 ...
 * Page class
 */
class master_user_permission_delete extends master_user_permission
{
	...
	// Page object name
	public $PageObjName = "master_user_permission_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("master_user_permissionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("master_user_permissionlist.php"); // Return to list
			}
		}
	}
