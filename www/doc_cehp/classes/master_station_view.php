 ...
 * Page class
 */
class master_station_view extends master_station
{
	...
	// Page object name
	public $PageObjName = "master_station_view";
	...
	public function __construct()
	{
		...
		if (Get("StationId") !== NULL) {
			$this->RecKey["StationId"] = Get("StationId");
	...
	public function run()
	{
		...
		$this->StationName_hi->setVisibility();
		...
		$this->NewStationCode->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("StationId") !== NULL) {
				...
				$this->StationId->setFormValue(Route(2));
				$this->RecKey["StationId"] = $this->StationId->FormValue;
			} else {
				$returnUrl = "master_stationlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "master_stationlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "master_stationlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->Altitude->setDbValue($row['Altitude']);
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			// Altitude
			$this->Altitude->ViewValue = $this->Altitude->CurrentValue;
			$this->Altitude->ViewCustomAttributes = "";
			...
			// Altitude
			$this->Altitude->LinkCustomAttributes = "";
			$this->Altitude->HrefValue = "";
			$this->Altitude->TooltipValue = "";
