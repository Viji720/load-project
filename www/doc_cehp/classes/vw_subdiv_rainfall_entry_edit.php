 ...
 * Page class
 */
class vw_subdiv_rainfall_entry_edit extends vw_subdiv_rainfall_entry
{
	...
	// Page object name
	public $PageObjName = "vw_subdiv_rainfall_entry_edit";
	...
	public function run()
	{
		...
		$this->mst_status->Visible = FALSE;
		$this->mst_validated->Visible = FALSE;
