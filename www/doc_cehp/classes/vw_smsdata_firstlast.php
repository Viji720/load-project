...
/**
 * Table class for vw_smsdata_firstlast
 */
class vw_smsdata_firstlast extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vw_smsdata_firstlast';
		$this->TableName = 'vw_smsdata_firstlast';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_smsdata_firstlast`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// SenderMobileNumber
		$this->SenderMobileNumber = new DbField('vw_smsdata_firstlast', 'vw_smsdata_firstlast', 'x_SenderMobileNumber', 'SenderMobileNumber', '`SenderMobileNumber`', '`SenderMobileNumber`', 200, 25, -1, FALSE, '`SenderMobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SenderMobileNumber->Sortable = TRUE; // Allow sort
		$this->fields['SenderMobileNumber'] = &$this->SenderMobileNumber;

		// first_reading_date
		$this->first_reading_date = new DbField('vw_smsdata_firstlast', 'vw_smsdata_firstlast', 'x_first_reading_date', 'first_reading_date', '`first_reading_date`', CastDateFieldForLike("`first_reading_date`", 0, "DB"), 135, 19, 0, FALSE, '`first_reading_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// last_reading_date
		$this->last_reading_date = new DbField('vw_smsdata_firstlast', 'vw_smsdata_firstlast', 'x_last_reading_date', 'last_reading_date', '`last_reading_date`', CastDateFieldForLike("`last_reading_date`", 0, "DB"), 135, 19, 0, FALSE, '`last_reading_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vw_smsdata_firstlast`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "vw_smsdata_firstlastlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vw_smsdata_firstlastview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vw_smsdata_firstlastedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vw_smsdata_firstlastadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vw_smsdata_firstlastview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vw_smsdata_firstlastview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vw_smsdata_firstlastadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vw_smsdata_firstlastadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_smsdata_firstlastedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_smsdata_firstlastadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vw_smsdata_firstlastdelete.php", $this->getUrlParm());
	}
