...
/**
 * Table class for vw_tbl_sms_monthly_subdivision
 */
class vw_tbl_sms_monthly_subdivision extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vw_tbl_sms_monthly_subdivision';
		$this->TableName = 'vw_tbl_sms_monthly_subdivision';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_tbl_sms_monthly_subdivision`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// Slno
		$this->Slno = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Slno', 'Slno', '`Slno`', '`Slno`', 3, 11, -1, FALSE, '`Slno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// StationId
		$this->StationId = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_StationId', 'StationId', '`StationId`', '`StationId`', 3, 11, -1, FALSE, '`StationId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SubDivisionId
		$this->SubDivisionId = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_SubDivisionId', 'SubDivisionId', '`SubDivisionId`', '`SubDivisionId`', 3, 11, -1, FALSE, '`SubDivisionId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SenderMobileNumber
		$this->SenderMobileNumber = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_SenderMobileNumber', 'SenderMobileNumber', '`SenderMobileNumber`', '`SenderMobileNumber`', 200, 25, -1, FALSE, '`SenderMobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SenderMobileNumber->Sortable = TRUE; // Allow sort
		$this->fields['SenderMobileNumber'] = &$this->SenderMobileNumber;

		// Water_Year
		$this->Water_Year = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Water_Year', 'Water_Year', '`Water_Year`', '`Water_Year`', 200, 9, -1, FALSE, '`Water_Year`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Water_Year->Sortable = TRUE; // Allow sort
		$this->fields['Water_Year'] = &$this->Water_Year;

		// day_of_month
		$this->day_of_month = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_day_of_month', 'day_of_month', '`day_of_month`', '`day_of_month`', 3, 2, -1, FALSE, '`day_of_month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Jun_rainfall
		$this->Jun_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Jun_rainfall', 'Jun_rainfall', '`Jun_rainfall`', '`Jun_rainfall`', 4, 7, -1, FALSE, '`Jun_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Jul_rainfall
		$this->Jul_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Jul_rainfall', 'Jul_rainfall', '`Jul_rainfall`', '`Jul_rainfall`', 4, 7, -1, FALSE, '`Jul_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Aug_rainfall
		$this->Aug_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Aug_rainfall', 'Aug_rainfall', '`Aug_rainfall`', '`Aug_rainfall`', 4, 7, -1, FALSE, '`Aug_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Sep_rainfall
		$this->Sep_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Sep_rainfall', 'Sep_rainfall', '`Sep_rainfall`', '`Sep_rainfall`', 4, 7, -1, FALSE, '`Sep_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Oct_rainfall
		$this->Oct_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Oct_rainfall', 'Oct_rainfall', '`Oct_rainfall`', '`Oct_rainfall`', 4, 7, -1, FALSE, '`Oct_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nov_rainfall
		$this->Nov_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Nov_rainfall', 'Nov_rainfall', '`Nov_rainfall`', '`Nov_rainfall`', 4, 7, -1, FALSE, '`Nov_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Dec_rainfall
		$this->Dec_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Dec_rainfall', 'Dec_rainfall', '`Dec_rainfall`', '`Dec_rainfall`', 4, 7, -1, FALSE, '`Dec_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Jan_rainfall
		$this->Jan_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Jan_rainfall', 'Jan_rainfall', '`Jan_rainfall`', '`Jan_rainfall`', 4, 7, -1, FALSE, '`Jan_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Feb_rainfall
		$this->Feb_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Feb_rainfall', 'Feb_rainfall', '`Feb_rainfall`', '`Feb_rainfall`', 4, 7, -1, FALSE, '`Feb_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Mar_rainfall
		$this->Mar_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Mar_rainfall', 'Mar_rainfall', '`Mar_rainfall`', '`Mar_rainfall`', 4, 7, -1, FALSE, '`Mar_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Apr_rainfall
		$this->Apr_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_Apr_rainfall', 'Apr_rainfall', '`Apr_rainfall`', '`Apr_rainfall`', 4, 7, -1, FALSE, '`Apr_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// May_rainfall
		$this->May_rainfall = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_May_rainfall', 'May_rainfall', '`May_rainfall`', '`May_rainfall`', 4, 7, -1, FALSE, '`May_rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsChanged
		$this->IsChanged = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_IsChanged', 'IsChanged', '`IsChanged`', '`IsChanged`', 200, 1, -1, FALSE, '`IsChanged`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IsChanged->Nullable = FALSE; // NOT NULL field
		$this->IsChanged->Sortable = TRUE; // Allow sort
		$this->fields['IsChanged'] = &$this->IsChanged;

		// obs_owner
		$this->obs_owner = new DbField('vw_tbl_sms_monthly_subdivision', 'vw_tbl_sms_monthly_subdivision', 'x_obs_owner', 'obs_owner', '`obs_owner`', '`obs_owner`', 200, 18, -1, FALSE, '`obs_owner`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vw_tbl_sms_monthly_subdivision`";
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "`StationId` ASC,`Water_Year` ASC,`day_of_month` ASC";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "vw_tbl_sms_monthly_subdivisionlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "vw_tbl_sms_monthly_subdivisionedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vw_tbl_sms_monthly_subdivisionadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vw_tbl_sms_monthly_subdivisionview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vw_tbl_sms_monthly_subdivisionview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vw_tbl_sms_monthly_subdivisionadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vw_tbl_sms_monthly_subdivisionadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_tbl_sms_monthly_subdivisionedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_tbl_sms_monthly_subdivisionadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vw_tbl_sms_monthly_subdivisiondelete.php", $this->getUrlParm());
	}
	...
	public function getUserIDSubquery(&$fld, &$masterfld)
	{
		global $UserTable;
		$wrk = "";
		$sql = "SELECT " . $masterfld->Expression . " FROM `vw_tbl_sms_monthly_subdivision`";
