 ...
 * Page class
 */
class obs_sms_messages_add extends obs_sms_messages
{
	...
	// Page object name
	public $PageObjName = "obs_sms_messages_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "obs_sms_messagesview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->sms_statusid->CurrentValue = NULL;
		$this->sms_statusid->OldValue = $this->sms_statusid->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['sms_statusid'] = $this->sms_statusid->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// message_id
		$this->message_id->setDbValueDef($rsnew, $this->message_id->CurrentValue, 0, FALSE);
		...
		// sms_statusid
		$this->sms_statusid->setDbValueDef($rsnew, $this->sms_statusid->CurrentValue, NULL, FALSE);
		...
		if ($insertRow && $this->ValidateKey && strval($rsnew['message_id']) == "") {
