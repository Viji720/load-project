...
/**
 * Table class for vw_rpt_rainfall_subdivision
 */
class vw_rpt_rainfall_subdivision extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vw_rpt_rainfall_subdivision';
		$this->TableName = 'vw_rpt_rainfall_subdivision';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_rpt_rainfall_subdivision`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// Slno
		$this->Slno = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_Slno', 'Slno', '`Slno`', '`Slno`', 3, 11, -1, FALSE, '`Slno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// SMSDateTime
		$this->SMSDateTime = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_SMSDateTime', 'SMSDateTime', '`SMSDateTime`', CastDateFieldForLike("`SMSDateTime`", 7, "DB"), 135, 19, 7, FALSE, '`SMSDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubDivisionId
		$this->SubDivisionId = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_SubDivisionId', 'SubDivisionId', '`SubDivisionId`', '`SubDivisionId`', 3, 11, -1, FALSE, '`SubDivisionId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// StationId
		$this->StationId = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_StationId', 'StationId', '`StationId`', '`StationId`', 3, 11, -1, FALSE, '`StationId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Rainfall
		$this->Rainfall = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_Rainfall', 'Rainfall', '`Rainfall`', '`Rainfall`', 4, 7, -1, FALSE, '`Rainfall`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Status
		$this->Status = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_Status', 'Status', '`Status`', '`Status`', 3, 11, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Validated
		$this->Validated = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_Validated', 'Validated', '`Validated`', '`Validated`', 3, 11, -1, FALSE, '`Validated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// StationName
		$this->StationName = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_StationName', 'StationName', '`StationName`', '`StationName`', 200, 30, -1, FALSE, '`StationName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StationName->Sortable = TRUE; // Allow sort
		$this->fields['StationName'] = &$this->StationName;

		// StationName_kn
		$this->StationName_kn = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_StationName_kn', 'StationName_kn', '`StationName_kn`', '`StationName_kn`', 200, 30, -1, FALSE, '`StationName_kn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StationName_kn->Sortable = TRUE; // Allow sort
		$this->fields['StationName_kn'] = &$this->StationName_kn;

		// StationCode
		$this->StationCode = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_StationCode', 'StationCode', '`StationCode`', '`StationCode`', 3, 11, -1, FALSE, '`StationCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MobileNumber
		$this->MobileNumber = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_MobileNumber', 'MobileNumber', '`MobileNumber`', '`MobileNumber`', 200, 15, -1, FALSE, '`MobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MobileNumber->Sortable = TRUE; // Allow sort
		$this->fields['MobileNumber'] = &$this->MobileNumber;

		// IsActive
		$this->IsActive = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_IsActive', 'IsActive', '`IsActive`', '`IsActive`', 200, 1, -1, FALSE, '`IsActive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IsActive->Nullable = FALSE; // NOT NULL field
		$this->IsActive->Sortable = TRUE; // Allow sort
		$this->fields['IsActive'] = &$this->IsActive;

		// DivisionId
		$this->DivisionId = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_DivisionId', 'DivisionId', '`DivisionId`', '`DivisionId`', 3, 11, -1, FALSE, '`DivisionId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DistrictId
		$this->DistrictId = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_DistrictId', 'DistrictId', '`DistrictId`', '`DistrictId`', 3, 11, -1, FALSE, '`DistrictId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TalukID
		$this->TalukID = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_TalukID', 'TalukID', '`TalukID`', '`TalukID`', 3, 11, -1, FALSE, '`TalukID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// BasinId
		$this->BasinId = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_BasinId', 'BasinId', '`BasinId`', '`BasinId`', 3, 11, -1, FALSE, '`BasinId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SubBasinId
		$this->SubBasinId = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_SubBasinId', 'SubBasinId', '`SubBasinId`', '`SubBasinId`', 3, 11, -1, FALSE, '`SubBasinId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// obs_owner
		$this->obs_owner = new DbField('vw_rpt_rainfall_subdivision', 'vw_rpt_rainfall_subdivision', 'x_obs_owner', 'obs_owner', '`obs_owner`', '`obs_owner`', 200, 18, -1, FALSE, '`obs_owner`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`vw_rpt_rainfall_subdivision`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "vw_rpt_rainfall_subdivisionlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vw_rpt_rainfall_subdivisionview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vw_rpt_rainfall_subdivisionedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vw_rpt_rainfall_subdivisionadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("vw_rpt_rainfall_subdivisionview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vw_rpt_rainfall_subdivisionview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "vw_rpt_rainfall_subdivisionadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vw_rpt_rainfall_subdivisionadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_rpt_rainfall_subdivisionedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vw_rpt_rainfall_subdivisionadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vw_rpt_rainfall_subdivisiondelete.php", $this->getUrlParm());
	}
	...
	public function getUserIDSubquery(&$fld, &$masterfld)
	{
		global $UserTable;
		$wrk = "";
		$sql = "SELECT " . $masterfld->Expression . " FROM `vw_rpt_rainfall_subdivision`";
