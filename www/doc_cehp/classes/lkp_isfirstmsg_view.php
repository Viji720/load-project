 ...
 * Page class
 */
class lkp_isfirstmsg_view extends lkp_isfirstmsg
{
	...
	// Page object name
	public $PageObjName = "lkp_isfirstmsg_view";
	...
	public function __construct()
	{
		...
		if (Get("isFirstMsg") !== NULL) {
			$this->RecKey["isFirstMsg"] = Get("isFirstMsg");
			$keyUrl .= "&amp;isFirstMsg=" . urlencode($this->RecKey["isFirstMsg"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("isFirstMsg") !== NULL) {
				...
				$this->RecKey["isFirstMsg"] = $this->isFirstMsg->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->isFirstMsg->setQueryStringValue(Key(0));
				$this->RecKey["isFirstMsg"] = $this->isFirstMsg->QueryStringValue;
			} elseif (Post("isFirstMsg") !== NULL) {
				$this->isFirstMsg->setFormValue(Post("isFirstMsg"));
				$this->RecKey["isFirstMsg"] = $this->isFirstMsg->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->isFirstMsg->setFormValue(Route(2));
				$this->RecKey["isFirstMsg"] = $this->isFirstMsg->FormValue;
			} else {
				$returnUrl = "lkp_isfirstmsglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "lkp_isfirstmsglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "lkp_isfirstmsglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
