 ...
 * Page class
 */
class lkp_validated_delete extends lkp_validated
{
	...
	// Page object name
	public $PageObjName = "lkp_validated_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lkp_validatedlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lkp_validatedlist.php"); // Return to list
			}
		}
	}
