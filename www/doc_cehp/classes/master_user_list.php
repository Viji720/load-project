 ...
 * Page class
 */
class master_user_list extends master_user
{
	...
	// Page object name
	public $PageObjName = "master_user_list";

	// Grid form hidden field names
	public $FormName = "fmaster_userlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "master_useradd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "master_userdelete.php";
		$this->MultiUpdateUrl = "master_userupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fmaster_userlistsrch";
	...
	public function run()
	{
		...
		$this->_UserProfile->Visible = FALSE;
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fmaster_userlistsrch");
		...
		$filterList = Concat($filterList, $this->UserAddress->AdvancedSearch->toJson(), ","); // Field UserAddress
		...
		$filterList = Concat($filterList, $this->SubDivsionId->AdvancedSearch->toJson(), ","); // Field SubDivsionId
		$filterList = Concat($filterList, $this->DivisionId->AdvancedSearch->toJson(), ","); // Field DivisionId
		$filterList = Concat($filterList, $this->RoleId->AdvancedSearch->toJson(), ","); // Field RoleId
		$filterList = Concat($filterList, $this->UserPassword->AdvancedSearch->toJson(), ","); // Field UserPassword
		$filterList = Concat($filterList, $this->UserEmail->AdvancedSearch->toJson(), ","); // Field UserEmail
		$filterList = Concat($filterList, $this->UserMobileNumber->AdvancedSearch->toJson(), ","); // Field UserMobileNumber
		$filterList = Concat($filterList, $this->_UserProfile->AdvancedSearch->toJson(), ","); // Field UserProfile
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fmaster_userlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field UserAddress
		$this->UserAddress->AdvancedSearch->SearchValue = @$filter["x_UserAddress"];
		$this->UserAddress->AdvancedSearch->SearchOperator = @$filter["z_UserAddress"];
		$this->UserAddress->AdvancedSearch->SearchCondition = @$filter["v_UserAddress"];
		$this->UserAddress->AdvancedSearch->SearchValue2 = @$filter["y_UserAddress"];
		$this->UserAddress->AdvancedSearch->SearchOperator2 = @$filter["w_UserAddress"];
		$this->UserAddress->AdvancedSearch->save();
		...
		// Field SubDivsionId
		$this->SubDivsionId->AdvancedSearch->SearchValue = @$filter["x_SubDivsionId"];
		$this->SubDivsionId->AdvancedSearch->SearchOperator = @$filter["z_SubDivsionId"];
		$this->SubDivsionId->AdvancedSearch->SearchCondition = @$filter["v_SubDivsionId"];
		$this->SubDivsionId->AdvancedSearch->SearchValue2 = @$filter["y_SubDivsionId"];
		$this->SubDivsionId->AdvancedSearch->SearchOperator2 = @$filter["w_SubDivsionId"];
		$this->SubDivsionId->AdvancedSearch->save();
		...
		// Field RoleId
		$this->RoleId->AdvancedSearch->SearchValue = @$filter["x_RoleId"];
		$this->RoleId->AdvancedSearch->SearchOperator = @$filter["z_RoleId"];
		$this->RoleId->AdvancedSearch->SearchCondition = @$filter["v_RoleId"];
		$this->RoleId->AdvancedSearch->SearchValue2 = @$filter["y_RoleId"];
		$this->RoleId->AdvancedSearch->SearchOperator2 = @$filter["w_RoleId"];
		$this->RoleId->AdvancedSearch->save();
		...
		// Field UserEmail
		$this->UserEmail->AdvancedSearch->SearchValue = @$filter["x_UserEmail"];
		$this->UserEmail->AdvancedSearch->SearchOperator = @$filter["z_UserEmail"];
		$this->UserEmail->AdvancedSearch->SearchCondition = @$filter["v_UserEmail"];
		$this->UserEmail->AdvancedSearch->SearchValue2 = @$filter["y_UserEmail"];
		$this->UserEmail->AdvancedSearch->SearchOperator2 = @$filter["w_UserEmail"];
		$this->UserEmail->AdvancedSearch->save();

		// Field UserMobileNumber
		$this->UserMobileNumber->AdvancedSearch->SearchValue = @$filter["x_UserMobileNumber"];
		$this->UserMobileNumber->AdvancedSearch->SearchOperator = @$filter["z_UserMobileNumber"];
		$this->UserMobileNumber->AdvancedSearch->SearchCondition = @$filter["v_UserMobileNumber"];
		$this->UserMobileNumber->AdvancedSearch->SearchValue2 = @$filter["y_UserMobileNumber"];
		$this->UserMobileNumber->AdvancedSearch->SearchOperator2 = @$filter["w_UserMobileNumber"];
		$this->UserMobileNumber->AdvancedSearch->save();

		// Field UserProfile
		$this->_UserProfile->AdvancedSearch->SearchValue = @$filter["x__UserProfile"];
		$this->_UserProfile->AdvancedSearch->SearchOperator = @$filter["z__UserProfile"];
		$this->_UserProfile->AdvancedSearch->SearchCondition = @$filter["v__UserProfile"];
		$this->_UserProfile->AdvancedSearch->SearchValue2 = @$filter["y__UserProfile"];
		$this->_UserProfile->AdvancedSearch->SearchOperator2 = @$filter["w__UserProfile"];
		$this->_UserProfile->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->UserAddress, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->UserPassword, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->UserEmail, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->UserMobileNumber, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->_UserProfile, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->SubDivsionId, $ctrl); // SubDivsionId
			$this->updateSort($this->DivisionId, $ctrl); // DivisionId
			$this->updateSort($this->RoleId, $ctrl); // RoleId
			$this->updateSort($this->UserPassword, $ctrl); // UserPassword
			$this->updateSort($this->UserEmail, $ctrl); // UserEmail
			$this->updateSort($this->UserMobileNumber, $ctrl); // UserMobileNumber
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->SubDivsionId->setSort("");
				$this->DivisionId->setSort("");
				$this->RoleId->setSort("");
				$this->UserPassword->setSort("");
				$this->UserEmail->setSort("");
				$this->UserMobileNumber->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fmaster_userlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmaster_userlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fmaster_userlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function newRow()
	{
		...
		$row['TalukId'] = NULL;
		$row['DistrictId'] = NULL;
		$row['SubDivsionId'] = NULL;
		$row['DivisionId'] = NULL;
		$row['RoleId'] = NULL;
		$row['UserPassword'] = NULL;
		$row['UserEmail'] = NULL;
		$row['UserMobileNumber'] = NULL;
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fmaster_userlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fmaster_userlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fmaster_userlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_master_user" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_master_user\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fmaster_userlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fmaster_userlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
