...
<input type="hidden" name="x_RoleId" id="x_RoleId" value="<?php echo $userpriv->RoleId->CurrentValue ?>">
<div class="ew-desktop">
<div class="card ew-card ew-user-priv">
<div class="card-header">
	<h3 class="card-title"><?php echo $Language->phrase("UserLevel") ?><?php echo $Security->getUserLevelName((int)$userpriv->RoleId->CurrentValue) ?> (<?php echo $userpriv->RoleId->CurrentValue ?>)</h3>
